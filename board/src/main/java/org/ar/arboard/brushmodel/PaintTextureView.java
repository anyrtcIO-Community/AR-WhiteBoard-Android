...
public class PaintTextureView extends TextureView implements TextureView.SurfaceTextureListener, View.OnTouchListener{
    ...
    public PaintTextureView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
...
//    }
    ...
    public void doDraw() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                synchronized (PaintTextureView.this) {
                    try {
                        canvas = lockCanvas();
                        drawBg(canvas);
