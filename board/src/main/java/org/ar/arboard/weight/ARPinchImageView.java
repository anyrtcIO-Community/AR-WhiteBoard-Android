 ...
 * 手势图片控件
 */
public class ARPinchImageView extends ImageView  {
    ...
    public boolean canScrollHorizontally(int direction) {
        if (mPinchMode == ARPinchImageView.PINCH_MODE_SCALE) {
            return true;
        }
    ...
    public interface OuterMatrixChangedListener {
         ...
         */
        void onOuterMatrixChanged(ARPinchImageView pinchImageView);
    }
    ...
    public ARPinchImageView(Context context) {
        super(context);
        initView();
    }

    public ARPinchImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public ARPinchImageView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * 在onTouchEvent末尾被执行.
     */
    private GestureDetector mGestureDetector = new GestureDetector(ARPinchImageView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(ARPinchImageView.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            if (mOnClickListener != null) {
                mOnClickListener.onClick(ARPinchImageView.this);
            }
            return true;
        }
    });
