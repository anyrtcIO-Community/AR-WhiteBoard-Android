...
public class ARBoardView extends FrameLayout {
    ...
    public ARBoardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ARBoardView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        view = LayoutInflater.from(context).inflate(R.layout.white_texture_board_layout, this);

        viewPager = (ARViewpager) view.findViewById(R.id.vp);

        viewPager.setARBoardConfig(arBoardConfig);

        paintView = (PaintTextureView) view.findViewById(R.id.paint_view);
